...
<form class="form-horizontal">
    <div class="form-group">
        <label class="col-md-2 control-label">Does the involvement of staff in these conferences / seminars / workshops provide benefit on PTJ?</label>
        <div class="col-md-8">
    ...
    <div class="form-group">
        <label class="col-md-2 control-label">What are follow-up plans / activities suggested by the staff to be implemented on PTj?</label>
        <div class="col-md-8">
    ...
    <div class="form-group">
        <label class="col-md-2 control-label">Comments if any</label>
        <div class="col-md-8">
