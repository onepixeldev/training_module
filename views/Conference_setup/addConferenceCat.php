<form id="addConferenceCat" class="form-horizontal" method="post">
    ...
    <div class="modal-body">
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                <?php
                    echo form_dropdown('form[head_recommend]', array(''=>'---Please Select---', 'Y'=>'YES', 'N'=>'NO'), '', 'class="selectpicker form-control width-50"')
                ?>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                <?php
                    echo form_dropdown('form[tnc_approve]', array(''=>'---Please Select---', 'Y'=>'YES', 'N'=>'NO'), '', 'class="selectpicker form-control width-50"')
                ?>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                <?php
                    echo form_dropdown('form[vc_approve]', array(''=>'---Please Select---', 'Y'=>'YES', 'N'=>'NO'), '', 'class="selectpicker form-control width-50"')
                ?>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                <?php
                    echo form_dropdown('form[status]', array(''=>'---Please Select---', 'Y'=>'ACTIVE', 'N'=>'INACTIVE'), '', 'class="selectpicker form-control width-50"')
                ?>
            </div>
        </div>
    </div>
