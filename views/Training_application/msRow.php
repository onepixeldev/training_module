<?php
    if (!empty($tr_head_detl)) {
        ...
        <tr id="btnTr1">
            ...
            <td class="text-left col-md-4"><textarea class="form-control" type="text" rows="10" cols="50" readonly id="spObj">'. $tr_head_detl->THD_TRAINING_OBJECTIVE2 .'</textarea></td>
            <td class="text-left">
        ...
        <tr>
            ...
            <td class="text-left col-md-4"><textarea class="form-control" type="text" rows="10" cols="50" readonly id="msCont">'. $tr_head_detl->THD_TRAINING_CONTENT .'</textarea></td>
            <td class="text-left">
        ...
        <tr>
            ...
            <td class="text-left col-md-4" id="msComp">'. $tr_head_detl->TMCDESC .'</td>
            <td class="text-left">
