...
<div class="row">
	...
	<div class="container col-md-2">
		<div class="panel panel-default">
			<div class="panel-body"><?php echo $summary?></div>
		</div>
	</div>
			...
			if (!empty($staff_tr_list_con)) {
				...
				foreach ($staff_tr_list_con as $stlc) {
					...
					<tr>
						...
						<td class="text-center col-md-1 sid">' . $stlc->SM_STAFF_ID . '</td>
						...
						<td class="text-center col-md-1 attend">' . $stlc->STD_ATTEND . '</td>
						...
						<td class="text-center col-md-1">
							<div class="btn-group">
								...
								<div style="background-color:silver;text-align:center;width:5px;" class="dropdown-menu dropdown-menu-right dd_btn">
									<button type="button" class="btn btn-danger text-left btn-block btn-xs resend_email_btn"><i class="fa fa-envelope-o"></i> Resend Email</button>
									<button type="button" class="btn btn-primary text-left btn-block btn-xs auto_conf_btn"><i class="fa fa-check-square"></i> Auto Confirmation</button>
