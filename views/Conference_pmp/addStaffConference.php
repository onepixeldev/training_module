...
<form id="addStaffConference" class="form-horizontal" method="post">
    ...
    <div class="form-group">
        ...
        <div class="col-md-2">
            <input name="form[conference_title]" placeholder="Conference Title" class="form-control" type="text" value="<?php echo $refid?>" readonly>
        </div>

        <div class="col-md-8">
            <input name="form[conference_name]" placeholder="Conference Title" class="form-control" type="text" value="<?php echo $crName?>" readonly>
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-md-10">
            <input name="form[venue]" placeholder="Venue" value="<?php echo $venue?>" class="form-control" type="text">
        </div>
    </div>
    ...
    <div class="form-group">    
        ...
        <div class="col-md-4">
            <input name="form[venue]" placeholder="City" value="<?php echo $city?>" class="form-control" type="text">
        </div>

        <label class="col-md-2 control-label">Postcode</label>
        <div class="col-md-2">
            <input name="form[postcode]" placeholder="Postcode" value="<?php echo $postcode?>" class="form-control" type="text">
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-md-4">
            <input name="form[state]" placeholder="State" value="<?php echo $state?>" class="form-control" type="text">
        </div>
        
        <label class="col-md-2 control-label">Country</label>
        <div class="col-md-4">
            <input name="form[country]" placeholder="Country" value="<?php echo $country?>" class="form-control" type="text">
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-md-4">
            <input name="form[date_from]" placeholder="DD-MM-YYYY" value="<?php echo $date_from?>" class="datepicker form-control" type="text">
        </div>


        <label class="col-md-2 control-label">Date To</label>
        <div class="col-md-4">
            <input name="form[date_to]" placeholder="DD-MM-YYYY" value="<?php echo $date_to?>" class="datepicker form-control" type="text">
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-md-10">
            <input name="form[organizer]" placeholder="Organizer" value="<?php echo $organizer?>" class="form-control" type="text">
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-md-4">
            <?php
                echo form_dropdown('form[sponsor]', $cr_spon_list, '', 'class="form-control width-50"')
            ?>
        </div>
    ...
    <div class="form-group">
        <label class="col-md-2 control-label">Budget Origin for Sponsor</label>
        <div class="col-md-4">
            <?php
        ...
        <div class="col-md-4">
            <input name="form[total]" placeholder="Total (RM)" class="form-control" type="text">
        </div>
    </div>
