			...
			if (!empty($research_allw_detl)) {
				foreach ($research_allw_detl as $rad) {
                    ...
                    <tr>
                        ...
                        <td class="text-center col-md-1">' . number_format($rad->SCA_AMT_RM_APPROVE_VC, 2) . '</td>
                        <td class="text-center col-md-1">' . number_format($rad->SCA_AMT_FOREIGN_APPROVE_VC, 2) . '</td>
