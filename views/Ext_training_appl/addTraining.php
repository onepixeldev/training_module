<form id="addTraining" class="form-horizontal" method="post">
    ...
    <div class="form-group">
        ...
        <div class="col-md-4">
            <?php
                echo form_dropdown('form[country]', $country_dd, '', 'class="select2-filter form-control" id="country" style="width: 100%"')
            ?>
        </div>
    ...
    <div class="form-group">
        ...
        <div class="col-md-2">
            <input name="form[coordinator]" class="form-control" type="text" value="" id="coordinator_id">
        </div>
