...
<form class="form-horizontal">
	<div class="form-group">
		...
		<div class="col-md-8">
			<input name="form[conference_name]" class="form-control" type="text" value="<?php echo $tr_title?>" id="crName" readonly>
		</div>
	</div>
</form>
<br>
<div class="well">
			...
			if (!empty($stf_list)) {
				foreach ($stf_list as $sl=>$val) {
                    ...
                    <tr>
						...
						<td class="text-center col-md-1">' . $val['KTP'] . '</td>
						<td class="text-center col-md-1">' . $val['REG'] . '</td>
	...
	<div class="row">
		<div class="text-left col-md-6">
			<button type="button" class="btn btn-primary btn-sm app_stf" data-refid="<?php echo ''?>" data-staff-id="<?php echo ''?>"><i class="fa fa-check-square"></i> Approve</button>
			<button type="button" class="btn btn-danger btn-sm rej_stf" data-refid="<?php echo ''?>" data-staff-id="<?php echo ''?>"><i class="fa fa-times-circle"></i> Reject</button>
